...
"""autogenerated by genpy from lab_project/OdomRecordActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class OdomRecordActionFeedback(genpy.Message):
  _md5sum = "47f35b797ac978470dd2ea8cb7395bf5"
  _type = "lab_project/OdomRecordActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lab_project/OdomRecordFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OdomRecordActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = lab_project.msg.OdomRecordFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = lab_project.msg.OdomRecordFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_total,) = _get_struct_f().unpack(str[start:end])
      return self
