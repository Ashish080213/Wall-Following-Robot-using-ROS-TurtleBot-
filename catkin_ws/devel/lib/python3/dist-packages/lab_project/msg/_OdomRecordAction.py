...
"""autogenerated by genpy from lab_project/OdomRecordAction.msg. Do not edit."""
import codecs
import sys
...
import lab_project.msg
import std_msgs.msg

class OdomRecordAction(genpy.Message):
  _md5sum = "1313a6dba27f93b75289b462eb34e80b"
  _type = "lab_project/OdomRecordAction"
...
"""
  ...
  _slot_types = ['lab_project/OdomRecordActionGoal','lab_project/OdomRecordActionResult','lab_project/OdomRecordActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OdomRecordAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = lab_project.msg.OdomRecordActionGoal()
      if self.action_result is None:
        self.action_result = lab_project.msg.OdomRecordActionResult()
      if self.action_feedback is None:
        self.action_feedback = lab_project.msg.OdomRecordActionFeedback()
    else:
      self.action_goal = lab_project.msg.OdomRecordActionGoal()
      self.action_result = lab_project.msg.OdomRecordActionResult()
      self.action_feedback = lab_project.msg.OdomRecordActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_result.result.list_of_odoms)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.list_of_odoms:
        _x = val1
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.current_total
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.list_of_odoms = []
      for i in range(0, length):
        ...
        self.action_result.result.list_of_odoms.append(val1)
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.current_total,) = _get_struct_f().unpack(str[start:end])
      return self
