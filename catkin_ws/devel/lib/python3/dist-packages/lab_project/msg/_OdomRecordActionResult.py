...
"""autogenerated by genpy from lab_project/OdomRecordActionResult.msg. Do not edit."""
import codecs
import sys
...
class OdomRecordActionResult(genpy.Message):
  _md5sum = "4e7fe22471f2999757b6c0c2bfd21119"
  _type = "lab_project/OdomRecordActionResult"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lab_project/OdomRecordResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OdomRecordActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = lab_project.msg.OdomRecordResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = lab_project.msg.OdomRecordResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.list_of_odoms)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.list_of_odoms:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.list_of_odoms.append(val1)
      return self
