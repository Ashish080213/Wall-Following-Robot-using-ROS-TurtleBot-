...
(cl:defmethod cl:initialize-instance :after ((m <FindWall-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindWall-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab_project-srv:<FindWall-request> is deprecated: use lab_project-srv:FindWall-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <FindWall-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindWall-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab_project-srv:<FindWall-response> is deprecated: use lab_project-srv:FindWall-response instead.")))

(cl:ensure-generic-function 'wallfound-val :lambda-list '(m))
(cl:defmethod wallfound-val ((m <FindWall-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab_project-srv:wallfound-val is deprecated.  Use lab_project-srv:wallfound instead.")
  (wallfound m))
